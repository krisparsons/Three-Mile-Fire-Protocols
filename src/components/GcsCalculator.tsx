  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h2 className="text-xl font-bold tracking-tight text-zinc-900 dark:text-white">GCS Calculator</h2>
          <p className="text-[10px] font-mono text-emerald-600 dark:text-emerald-500 uppercase tracking-widest mt-1">Glasgow Coma Scale</p>
        </div>
      </div>
